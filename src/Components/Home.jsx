        ...
        <div className="container">
          <div className="row">
            <div className="col-md-8 mx-auto m-3">
              <h1 className="display-4 fw-bolder mb-4 text-center text-white  ">Feels the Fresh Buisnnes Perpective</h1>
              ...
              <div className="buttons d-flex justify-content-center">
                  ...
                  <button className="btn btn-outline-light rounded-pill px-4 py-2">Our Srevices</button>
              </div>
            </div>
          </div>
        </div>
